 ...
 * @version 1.0.0
 * @desc 网络状态获取工具类
 * @time 2018/10/28 - 6:03 PM
 */
public class NetworkTools {

    private static final int NETWORK_STATE_CONNECTING = -2;
    private static final int NETWORK_STATE_NONE = -1;
    private static final int NETWORK_STATE_WIFI = 1;
    private static final int NETWORK_STATE_2G = 2;
    private static final int NETWORK_STATE_3G = 3;
    private static final int NETWORK_STATE_4G = 4;
    private static final int NETWORK_STATE_MOBILE_UNKNOWN = 5;
