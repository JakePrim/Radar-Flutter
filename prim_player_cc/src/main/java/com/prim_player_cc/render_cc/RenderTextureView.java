...
public class RenderTextureView extends TextureView implements IRenderView {
    ...
    private static final class SurfaceCallback implements TextureView.SurfaceTextureListener, ISurfaceTextureHost {
        ...
        public SurfaceCallback(RenderTextureView renderTextureView) {
    ...
    private static final class InternalSurfaceHolder implements IRenderView.ISurfaceHolder {
        ...
        public InternalSurfaceHolder(RenderTextureView renderTextureView, SurfaceTexture surfaceTexture, ISurfaceTextureHost surfaceTextureHost) {
