...
/// [TolySwitchListTile] itself but by the [Material] widget ancestor. In this
/// case, one can wrap a [Material] widget around the [TolySwitchListTile], e.g.:
///
/// {@tool snippet}
/// ```dart
/// Container(
...
/// {@end-tool}
///
/// ## Performance considerations when wrapping [TolySwitchListTile] with [Material]
///
/// Wrapping a large number of [TolySwitchListTile]s individually with [Material]s
/// is expensive. Consider only wrapping the [TolySwitchListTile]s that require it
/// or include a common [Material] ancestor where possible.
///
/// To show the [TolySwitchListTile] as disabled, pass null as the [onChanged]
/// callback.
///
/// {@tool dartpad}
...
class TolySwitchListTile extends StatelessWidget {
  ...
  ///
  /// Insets a [TolySwitchListTile]'s contents: its [title], [subtitle],
  ...
  /// If non-null, defines the background color when [TolySwitchListTile.selected] is true.
