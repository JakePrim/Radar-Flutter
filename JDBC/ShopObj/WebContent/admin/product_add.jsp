    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form id="admin-form" name="addForm" enctype="multipart/form-data"  action="${pageContext.request.contextPath }/admin/product?method=save" method="post">
						 ...
						 <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="name" class="field">
                                    <input name="path" class="gui-input" type="file" value="上传图片"/>
                                </label>
                            </div>
                        </div>						
						<div class="section row">
							...
							<div class="col-md-6">
								<label for="address" class="field">
									<input name="desc" class="gui-input" placeholder="描述" type="text" value=""/>
								</label>
							</div>
                        </div>
