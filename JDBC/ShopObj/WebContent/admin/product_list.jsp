                ...
                <div class="panel-menu">
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default light" onclick="javascript:window.location.href='${pageContext.request.contextPath }/admin/product?method=findAll';">
                                    <i class="fa fa-refresh"></i>
                                </button>
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-trash"></i>
                                </button>
                                <button type="button" class="btn btn-default light" onclick="javascript:window.location.href='${pageContext.request.contextPath }/admin/product?method=saveUI';">
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <c:forEach items="${products }" var="p">
	                        <tr class="message-unread">
	                                ...
	                                <td>${p.price }</td>
									<td>${p.author }</td>
									<td><img alt="1" src="${pageContext.request.contextPath }${p.path }" style="width: 100px;height: 100px;"></td>
									<td>${p.desc }</td>
	                                <td>
	                                    <a href="${pageContext.request.contextPath }/admin/product?method=updateUI&pid=${p.id }">编辑</a>
	                                    <a href="${pageContext.request.contextPath }/admin/product?method=delete&pid=${p.id }">删除</a>
	                                </td>
	                            </tr>
                        </c:forEach>                            							
                      </tbody>
