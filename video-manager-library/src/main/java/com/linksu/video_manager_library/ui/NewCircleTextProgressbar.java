 ...
 * ================================================
 */
public class NewCircleTextProgressbar extends android.support.v7.widget.AppCompatTextView {
    /**
     * 外部轮廓的颜色。
     */
    ...
    public NewCircleTextProgressbar(Context context) {
        this(context, null);
    }

    public NewCircleTextProgressbar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initialize(context, attrs);
    }

    public NewCircleTextProgressbar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs);
    }

//    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
//    public NewCircleTextProgressbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//    }
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.NewCircleTextProgressbar);
        if (typedArray.hasValue(R.styleable.NewCircleTextProgressbar_in_circle_color))
            inCircleColors = typedArray.getColorStateList(R.styleable.NewCircleTextProgressbar_in_circle_color);
        else
            inCircleColors = ColorStateList.valueOf(Color.TRANSPARENT);
        circleColor = inCircleColors.getColorForState(getDrawableState(), Color.TRANSPARENT);
        outLineColor = typedArray.getColor(R.styleable.NewCircleTextProgressbar_out_line_color, Color.TRANSPARENT);
        progressLineColor = typedArray.getColor(R.styleable.NewCircleTextProgressbar_progress_color, Color.TRANSPARENT);
        outLineWidth = typedArray.getDimensionPixelSize(R.styleable.NewCircleTextProgressbar_out_line_width, 0);
        outLineWidth = convertDpToPixelInt(getContext(), outLineWidth);
        progressLineWidth = typedArray.getDimensionPixelSize(R.styleable.NewCircleTextProgressbar_circle_width, 8);
        progressLineWidth = convertDpToPixelInt(getContext(), progressLineWidth);
        typedArray.recycle();
    }
