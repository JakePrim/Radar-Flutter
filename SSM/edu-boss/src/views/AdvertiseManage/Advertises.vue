<template>
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="homeAdvertiseTable" :data="list" style="width: 100%;" v-loading="listLoading" border>
        ...
        <el-table-column label="广告位置" width="200" align="center">
          <template slot-scope="scope">{{scope.row.promotionSpace.name}}</template>
        </el-table-column>
        ...
        <el-table-column label="上线/下线" width="120" align="center">
          <template slot-scope="scope">
            <el-switch @change="handleUpdateStatus(scope.row)" :active-value="1" :inactive-value="0" v-model="scope.row.status"></el-switch>
          </template>
        </el-table-column>
    ...
    <div class="pagination-container">
      <el-pagination background @size-change="handlePageSizeChange" @current-change="handleCurrentPageChange" layout="total, sizes,prev, pager, next,jumper" :current-page="page" :page-sizes="[5,10, 20]" :page-size="size" :total="total"></el-pagination>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    loadPromotionAd() {
      ...
      return axios.get(`/PromotionAd/findAllPromotionAdByPage`,{
        params:{
