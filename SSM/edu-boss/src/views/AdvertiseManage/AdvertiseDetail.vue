  ...
  <el-card class="form-container" shadow="never">
    ...
    <el-form :model="homeAdvertise" :rules="rules" ref="form" label-width="150px" size="small">
      ...
      <el-form-item label="广告图片：">
        <upload-image :content="homeAdvertise.img && [homeAdvertise.img]" :get-urls="getADImgUrl" uploadUrl="/PromotionAd/PromotionAdUpload" ref="courseCoverRef" max="10M" tipInfo="建议尺寸：230*300px，JPG、PNG格式，图片小于150K" />
      </el-form-item>
      ...
      <el-form-item label="广告备注：">
        <el-input class="input-width" type="textarea" :rows="5" placeholder="请输入内容" v-model="homeAdvertise.text"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    ...
    handleSave() {
      this.$refs.form.validate(valid=>{
        ...
        axios.post('/PromotionAd/saveOrUpdatePromotionAd',this.homeAdvertise)
          .then(res=>{
            this.$router.back()
        }).catch(()=>{
          this.$message('保存广告信息失败')
        })
      })
    },
